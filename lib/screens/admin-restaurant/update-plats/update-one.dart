...
class UpdateOnePlats extends StatelessWidget {
  const UpdateOnePlats({super.key});
    ...
    return ListView(
      children: [
                            ...
                            children: [
                              Expanded(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () =>
                                        addPlatRestaurantBloc.getPhotoUpdate1(),
                                    child: Container(
                                        decoration: BoxDecoration(
                                            borderRadius:
                                                BorderRadius.circular(8),
                                  ...
                                  if (addPlatRestaurantBloc.photoUpdate1[0] !=
                                      null)
                                    Positioned(
                                        right: 8,
                                        top: 8,
                              ...
                              Expanded(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () =>
                                        addPlatRestaurantBloc.getPhotoUpdate2(),
                                    child: Container(
                                        decoration: BoxDecoration(
                                            borderRadius:
                                                BorderRadius.circular(8),
                                  ...
                                  if (addPlatRestaurantBloc.photoUpdate2[0] !=
                                      null)
                                    Positioned(
                                        right: 8,
                                        top: 8,
            ...
            children: [
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Consomable seleument sur place',
                      style: TextStyle(
        ...
        Row(
          ...
          children: [
            GestureDetector(
              onTap: () => addPlatRestaurantBloc.setMenuAUpdate(1),
              child: Container(
                height: 45,
                decoration: BoxDecoration(
