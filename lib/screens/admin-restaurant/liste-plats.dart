...
class ListePlatsScreen extends StatelessWidget {
  const ListePlatsScreen({super.key});
        ...
        Column(
          children: [
            GridView.count(
                ...
                children: adminRestaurantBloc.listes
                    .map((e) => Padding(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          'prix (TTC) : ${getFormatPrice(e.tarif!)}  ',
                                                          style: TextStyle(
                                                              fontSize: 12,
                                                              color: noir),
                                                        ),
