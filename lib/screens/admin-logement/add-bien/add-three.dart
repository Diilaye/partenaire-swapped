...
class AddThreeLogement extends StatelessWidget {
  const AddThreeLogement({super.key});
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: addLogementBloc.buanderieCommodites
                        .map(
                          (e) => Padding(
            ...
            Expanded(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    scrollDirection: Axis.horizontal,
                    children: addLogementBloc.jardinCommodites
                        .map(
                          (e) => Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: GestureDetector(
                              onTap: () =>
                                  addLogementBloc.setSelectedJardinCommodite(e),
                              child: Container(
                                height: 120,
                                width: 120,
                                decoration: BoxDecoration(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    if (addLogementBloc.selectedJardinCommodite
                                        .contains(e))
                                      Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.end,
            ...
            Expanded(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    scrollDirection: Axis.horizontal,
                    children: addLogementBloc.serviceAnnexeCommodites
                        .map(
                          (e) => Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: GestureDetector(
